# Generated by Powerlevel10k configuration wizard on 2020-06-13 at 14:59 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    prompt_char             # prompt symbol (for transient time hack)
  )
...
function p10k-on-pre-prompt() { p10k display '1'=show '2/right/time'=hide '2/left/prompt_char'=hide '2/left_frame'=show '2/right_frame'=show 'empty_line'=show }
function p10k-on-post-prompt() { p10k display '1'=hide '2/right/time'=show '2/left/prompt_char'=show '2/left_frame'=hide '2/right_frame'=hide 'empty_line'=hide }
