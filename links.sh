...
sudo ln -s ~/r79conf/conf/xorg-keyboard-conf /etc/X11/xorg.conf.d/00-keyboard.conf

#dhcpcd speedhack
sudo rm /etc/dhcpcd.conf
sudo ln -s ~/r79conf/conf/dhcpcd.conf /etc/dhcpcd.conf

#i3
rm ~/.config/i3/config
ln -s ~/r79conf/conf/i3-wm.conf ~/.config/i3/config

#zsh
rm ~/.zshrc
ln -s ~/r79conf/conf/.zshrc ~/.zshrc

#xfce4-terminal
rm -r ~/.config/xfce4/terminal
ln -s ~/r79conf/conf/terminal ~/.config/xfce4/terminal

#i3status
#ignoring some errors here as they might happen if one runs the script another time
mkdir ~/.config/i3status
rm ~/.config/i3status/config
ln -s ~/r79conf/conf/i3status.conf ~/.config/i3status/config

#xinitrc
rm ~/.xinitrc
ln -s ~/r79conf/conf/.xinitrc ~/.xinitrc

#pikaur
rm ~/.config/pikaur.conf
ln -s ~/r79conf/conf/pikaur.conf ~/.config/pikaur.conf
